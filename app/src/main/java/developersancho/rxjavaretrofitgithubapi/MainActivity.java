...
import developersancho.rxjavaretrofitgithubapi.model.GithubIssue;
import developersancho.rxjavaretrofitgithubapi.model.GithubRepo;
import developersancho.rxjavaretrofitgithubapi.retrofit.GithubAPI;
import developersancho.rxjavaretrofitgithubapi.retrofit.GithubRepoDeserializer;
...
public class MainActivity extends AppCompatActivity implements CredentialsDialog.ICredentialsDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repositoriesSpinner.setAdapter(new ArrayAdapter<>(MainActivity.this,
                android.R.layout.simple_spinner_dropdown_item, new String[]{"No repositories available"}));
